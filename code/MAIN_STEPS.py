...
def main():
    ...
    output_video_shots_1, output_video_shots_2 = STEP_4_processing_output_shots(shots,SHOT_TYPES)


    # classifying shots Sequence _____________________________________________
    shots_classes = STEP_5_classifying_shot_sequence(output_video_shots_1,output_video_shots_2,SHOT_TYPES,EVENT_TYPES)



    #Final output ______________________________________________________________
    output_video_shots, final_video = STEP_6_processing_final_output( output_video_shots_1 , output_video_shots_2, shots_classes)
    ...
    STEP_7_file_output(shots_classes,EVENT_TYPES,video_name,shots,output_video_shots,output_video_shots_2,t1,t2)
