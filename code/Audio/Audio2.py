...
clip = VideoFileClip('C:/Users\\medo\\Desktop\\test1.mp4')
fps = clip.audio.fps


def cut(i): return clip.audio.subclip(i, i+1).to_soundarray(fps=fps)


def volume(array): return ((1.0*array)**2).mean()
...
print(peaks_times, peaks_times[0])
